...
frame.to_csv(r'Z:\PersonalFolders\_\Springboard\Projects\BackBlazeHDDfailure\frame.csv') # contains all column data
frame_5.to_csv(r'Z:\PersonalFolders\_\Springboard\Projects\BackBlazeHDDfailure\frame_5.csv') # contains 5 columns mentioned by BackBlaze
frame_5norm.to_csv(r'Z:\PersonalFolders\_\Springboard\Projects\BackBlazeHDDfailure\frame_5norm.csv') # contains only 5 normalized by BackBlaze
frame_5raw.to_csv(r'Z:\PersonalFolders\_\Springboard\Projects\BackBlazeHDDfailure\frame_5raw.csv') # contains only 5 normalized by BackBlaze
frame_8raw.to_csv(r'Z:\PersonalFolders\_\Springboard\Projects\BackBlazeHDDfailure\frame_8raw.csv') # contains only 5 raw by BackBlaze + smart_9 + 12 + 189 which is drive age


############# Import data into DataFrame from Exported clean CSV
df = pd.read_csv(r'Z:\PersonalFolders\_\Springboard\Projects\BackBlazeHDDfailure\frame_5raw.csv', parse_dates=True, index_col='date').fillna(0).drop('Unnamed: 0', axis=1)
...
df.to_csv(r'Z:\PersonalFolders\_\Springboard\Projects\BackBlazeHDDfailure\frame_5raw_clean.csv')


# for back blaze 5 smart + smart_9 + 12 + 189
df_8 = pd.read_csv(r'Z:\PersonalFolders\_\Springboard\Projects\BackBlazeHDDfailure\frame_8raw.csv', parse_dates=True, index_col='date').fillna(0).drop('Unnamed: 0', axis=1)
...
# Export cleaned data to CSV for archiving.
df_8.to_csv(r'Z:\PersonalFolders\_\Springboard\Projects\BackBlazeHDDfailure\frame_8raw_clean.csv')
...
# the Dataset has now reduced. This move was mainly to reduce the size of the dataset. Computational resources.
...
# Run the function that test 4 classifiers.
